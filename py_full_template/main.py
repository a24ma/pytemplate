...
log_package_name = "TODO:"  # Avoid __package__==None on main
...
suppress_lib_on_err = [click, pathlib]  # Suppressed lib.'s stacktrace
...
@click.option("--wait_ok", "-wok", "wait_ok", type=int, default=5)
